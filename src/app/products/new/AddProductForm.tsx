...
export default function AddProductForm() {
  ...
  return (
    <form
      method="post"
      action={addProduct}
      className="mx-auto w-full max-w-4xl bg-white dark:bg-slate-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-lg"
          ...
          <div className="relative rounded-xl overflow-hidden bg-gray-50 dark:bg-slate-800 h-64 flex items-center justify-center border border-gray-100 dark:border-slate-700">
            ...
            <div className="absolute bottom-3 left-3 right-3 flex gap-2">
              <input
                ...
                className="flex-1 rounded-md border border-gray-200 dark:border-slate-700 px-3 py-2 bg-white/90 dark:bg-slate-900/70 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
          </div>
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="mt-6 flex items-center justify-end gap-3">
            <button
              type="submit"
              disabled={isPending}
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-2.5 text-sm font-semibold text-white hover:opacity-95 disabled:opacity-60 transition-all shadow-lg"
            >
              {isPending ? (
                <>
                  <svg
          ...
          <div className="mt-6 flex items-center justify-end gap-3">
            <button
              ...
              className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-green-600 to-emerald-600 w-10 h-10 text-white hover:opacity-95 transition-all shadow-lg"
            >
              <svg
                className="w-5 h-5"
                fill="none"
